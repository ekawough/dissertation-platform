...
import os
from api.routes import clients, chapters, scratchpad, documents, feedback, dochat

app = FastAPI(title="Dissertation Platform", version="4.0")
...
app.include_router(dochat.router, prefix="/doc", tags=["DocChat"])
